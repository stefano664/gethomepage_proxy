...
# oppure manualmente:
docker build -t gethomepage-proxy:0.1.0 .

# 4. Aggiorna image: nel docker-compose.yml → gethomepage-proxy:1.1.0
...
# 5. Pusha l'immagine
docker tag gethomepage-proxy:0.1.0 ghcr.io/stefano664/gethomepage-proxy:0.1.0
docker push ghcr.io/stefano664/gethomepage-proxy:0.1.0
